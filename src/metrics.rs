...
pub struct MetricRecord {
    ...
    pub cross_resolution_l1: f32,
    pub cross_resolution_low: f32,
    pub cross_resolution_edge: f32,
    pub grounded_output_rms: f32,
    pub grounded_output_mean_abs: f32,
    pub grounded_output_variance: f32,
    pub emergent_output_rms: f32,
    pub emergent_output_mean_abs: f32,
    pub emergent_output_variance: f32,
    pub emergent_contribution_rms: f32,
    ...
    pub flow_loss: f32,
    pub flow_time: f32,
    pub flow_interpolant_rms: f32,
    pub flow_pred_velocity_rms: f32,
    pub flow_target_velocity_rms: f32,
    pub flow_velocity_cosine: f32,
    pub flow_one_step_endpoint_l1: f32,
...
impl MetricRecord {
    ...
    pub fn write_csv(&self, mut writer: impl Write) -> Result<()> {
        ...
        writeln!(
            writer,
            ",{},{},{},{},{},{:.7},{:.7},{:.3},{},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.9},{:.9},{:.9},{:.9},{:.9},{:.9},{:.9},{},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7},{:.7}",
            self.objective,
            self.supervision,
            self.active_morph_depth,
            self.physical_morph_layers,
            self.morph_generation,
            self.grounding_schedule,
            self.emergence_schedule,
            self.detail_zoom,
            self.pyramid_level,
            self.micro_reference_drive_rms,
            self.macro_reference_drive_rms,
            self.loss_endpoint,
            self.loss_grounding,
            self.loss_ground_coarse,
            self.loss_ground_mid,
            self.loss_ground_fine,
            self.loss_ssim,
            self.loss_emergent_fit,
            self.loss_emergent_low,
            self.loss_emergent_tv,
            self.head_redundancy,
            self.cross_resolution_l1,
            self.cross_resolution_low,
            self.cross_resolution_edge,
            self.grounded_output_rms,
            self.grounded_output_mean_abs,
            self.grounded_output_variance,
            self.emergent_output_rms,
            self.emergent_output_mean_abs,
            self.emergent_output_variance,
            self.emergent_contribution_rms,
            self.grounded_gradient_rms,
            self.emergent_gradient_rms,
            self.flow_gradient_rms,
            self.grounded_update_rms,
            self.emergent_update_rms,
            self.grounded_update_weight_ratio,
            self.emergent_update_weight_ratio,
            self.flow_active,
            self.flow_loss,
            self.flow_time,
            self.flow_interpolant_rms,
            self.flow_pred_velocity_rms,
            self.flow_target_velocity_rms,
            self.flow_velocity_cosine,
            self.flow_one_step_endpoint_l1,
            self.flow_condition_rms,
        )?;
        Ok(())
    }
}
